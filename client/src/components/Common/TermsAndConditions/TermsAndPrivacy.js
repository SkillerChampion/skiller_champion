        ...
        <div className={`flex flex-col ${isModalView ? 'gap-2' : 'gap-4'}`}>
          ...
          <div className={classes.root}>
            ...
            <span className={classes.bold}>
              WE ENCOURAGE YOU TO LIMIT YOUR GAMING AMOUNT FOR YOUR OWN SAFETY. IF YOU NEED HELP
              WITH CRYPTO GAMING, PLEASE REACH US OUT AT todo:COMPANYEMAIL. WE, IN ANY WAY DO NOT
              PROVIDE FINANCIAL ADVICE AND REQUEST YOU TO CONDUCT PROPER RESEARCH BEFORE PLAYING
              CRYPTO GAMES.
            </span>{' '}
          ...
          <div className={classes.root}>
            ...
            <span className={classes.bold}>
              MOREOVER, YOU AGREE TO VERIFY THAT CRYPTOCURRENCY GAMING BASED ON LUCK IS NOT
              PROHIBITED IN YOUR JURISDICTION, AND IF IT IS, YOU MUST IMMEDIATELY CEASE USING OUR
              SERVICE.
            </span>{' '}
          ...
          <div className={classes.root}>
            7 - Tokens: You understand the cryptocurrencies are highly volatile asset and are
            subject to market risk. The platform uses various cryptocurrencies such as Hbar, Skiller
            etc. in the games and are not liable for any losses/gains incurred due to price changes
            of these tokens. You understand that "Skiller" token a meme coin and has no intrinsic
            value. The purchase/use/airdrop/winning prize of "Skiller" and other tokens are only for
            fun and does not represent any kind of financial promises or liabilities.
          </div>
